...
@HiltViewModel
class ProductListViewmodel @Inject constructor(private val getProductsInfo: GetProductsInfo):ViewModel() {

    private val _searchQuery= mutableStateOf("")
    val searchQuery: State<String> = _searchQuery
    private val _state= mutableStateOf(ProductListInfoState())
    val state:State<ProductListInfoState> =_state
